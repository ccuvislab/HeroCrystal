...
def init_vgg16_rcnns(n_nets):
    '''
    [cyjui, 21/12/29]
    Initialize vgg16 for fasterRCNN.
    Please note that this part is hard coded right now
    '''
    from vgg import vgg16_rcnn 
...
#                                     (4,4,4,4),mode='reflect').data.squeeze()),
#                 transforms.ToPILImage(),
#                 transforms.Resize(IN_SIZE), # cyjui.
#                 transforms.RandomCrop(IN_SIZE), # original 32, cyjui.
#                 transforms.RandomHorizontalFlip(),
#                 transforms.ToTensor(),
#                 normalize,
#                 ])
...
#                 transforms.ToPILImage(),
#                 transforms.Resize(IN_SIZE), # cyjui.
#                 transforms.RandomCrop(IN_SIZE), # cyjui.
#                 transforms.RandomHorizontalFlip(),
#                 transforms.ToTensor(),
#                 normalize_colored,
#                 ])
...
def compute_ensemble_accuracy(models: list, dataloader, n_classes, 
                              train_cls_counts=None, 
                              uniform_weights=False, 
                              sanity_weights=False, device="cpu"):
...
#             print("In compute acc. {:}.".format(x.shape))
