...
class VGG11ContainerConvBlocks(nn.Module):
    def __init__(self, num_filters, output_dim=10):
        super(VGG11ContainerConvBlocks, self).__init__()
...
class VGG16ContainerConvBlocks(nn.Module):
    def __init__(self, num_filters, output_dim=10):
        
        super(VGG16ContainerConvBlocks, self).__init__()
        ...
        self.conv_layer = nn.Sequential(
            ...
            nn.Conv2d(in_channels=num_filters[0], out_channels=num_filters[0], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            ...
            nn.Conv2d(in_channels=num_filters[1], out_channels=num_filters[1], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            ...
            nn.Conv2d(in_channels=num_filters[1], out_channels=num_filters[2], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=num_filters[2], out_channels=num_filters[2], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(in_channels=num_filters[3], out_channels=num_filters[4], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=num_filters[4], out_channels=num_filters[4], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(in_channels=num_filters[5], out_channels=num_filters[6], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=num_filters[6], out_channels=num_filters[6], kernel_size=3, padding=1),
            nn.ReLU(inplace=True),
